...
export var comentarios_list:comentario[] = [
  ...
  {"idcomentario":5,"idjuego":0,"idcontenido":1,"user":"velocidadEscarlata","user_img":"img/avatar2.jpg","fecha":"Lunes 25 de Abril, 12:12","puntuacion":0,"mensaje":"A mi esta dando lastima, Uncharted es de mis sagas preferidas, pero no siento ninguna ansiedad respecto a este juego, estoy muy viciado con Dark Souls III, en otra época estaría contando los días, no se si caerá o no el día uno, me iba a deshacer de la reserva de la versión especial, pero lo he estado pensando y si es verdaderamente el ultimo titulo, o al menos el que le da un cierre a Drake, sería bastante bueno tenerla, definitivamente un juegazo en todos los sentidos. Lo que si lo ha reventado un poco para mi es el DLC que es parte del modo de un jugador, no me afecta lo que saquen para el multijugador ya que nunca me ha interesado pero para la historia si me mata un poco que le metan contenido adicional, todavía una expansión hubiera pasado."},
  {"idcomentario":6,"idjuego":0,"idcontenido":1,"user":"castorTresDientes","user_img":"img/avatar1.png","fecha":"Lunes 25 de Abril, 13:35","puntuacion":0,"mensaje":"Este modo es muy clásico, por supuesto que iba a estar. ND hace juegos con MP desde U2, todos ellos con una campaña envidiable, no sé de que estáis hablando. No termino de entender tu comentario. Yo también adoro muchísimo Dark Souls y me encanta Uncharted, deberíamos sentirnos afortunados de tener tantos juegazos juntos y a corto plazo a los que disfrutar... Mal sí hay y mal si no hay, que surrealista es todo xd. Y precisamente una expensión de la historia es lo que NO deberían hacer jamás. En ningún juego."},
  {"idcomentario":7,"idjuego":0,"idcontenido":3,"user":"castorTresDientes","user_img":"img/avatar1.png","fecha":"Viernes 22 de Abril, 13:35","puntuacion":0,"mensaje":"Tanta tirria le tienen los de disney a las precuelas que son capaces de ponerte al gordo vigilante del Rancor del episodio VI antes que ponerte a Darth Maul, Anakin o Windu. Y que no me vengan con lo de la coherencia porque es un juego que no tiene historia, con incoherencias cronológicas como Luke del episodio VI con su sable verde y el emperador luchando en Hoth. Creo que disney y sus nuevos directores, por mucho que no les gusten las precuelas, tienen que tener en cuenta que el público de Star Wars está dividido y que a la mitad si les gusta las precuelas y que incluso muchos de ellos, son lo primero que vieron de SW y se criaron con eso, por eso, no pueden dejar de lado a esa parte de los fans y solo centrarse en la otra mitad, además de ser una falta de respeto al creador original."}
