...
var datos1: Datos = {
  ...
  contenido: [{ id: 1, tipoprod: 3, name: "Deadpool", img: "img/deadpool.jpg", genero: null, plataforma: "pelicula"},
              ...
              { id: 1, tipoprod: 2, name: "Arrow", img: "img/arrow.jpg", genero: null, plataforma: "serie"},
              { id: 2, tipoprod: 2, name: "The walkind dead", img: "img/twd.jpg", genero: null, plataforma: "serie"},
              { id: 3, tipoprod: 2, name: "Los 100", img: "img/100.jpg", genero: null, plataforma: "serie"},
              { id: 1, tipoprod: 1, name: "XCOM 2", img: "img/xcom.jpg", genero: null, plataforma: "juego"},
              { id: 2, tipoprod: 1, name: "Civilization V", img: "img/civ5.jpg", genero: null, plataforma: "juego"}],
  amigos: []
};
