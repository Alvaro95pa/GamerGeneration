System.register(['angular2/core', './clases.service', './modoadmin.service', 'angular2/router', './prod-detalle.component', './sesion.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, clases_service_1, modoadmin_service_1, router_1, router_2, prod_detalle_component_1, sesion_service_1;
    var listobjetos;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            listobjetos = (function () {
                function listobjetos(router, _sesionService, adminservice, clasesservice, _routeParams) {
                    this.router = router;
                ...
                listobjetos.prototype.eliminarProd = function (produc) {
                    var _this = this;
                    this.adminservice.deleteProd(produc.id).subscribe(function (id) {
                        if (!_this.checkpelis && !_this.checkseries && !_this.checkjuego) {
                            _this.getproductos();
                        }
                        else {
                            _this.getproductosfiltro();
                        }
                    });
                };
                ...
                listobjetos = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, sesion_service_1.SesionService, modoadmin_service_1.modoadminservice, clases_service_1.clasesservice, router_2.RouteParams])
                ], listobjetos);
                return listobjetos;
            }());
