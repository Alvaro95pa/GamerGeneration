System.register(['angular2/core', 'angular2/router', './contenido.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, contenido_service_1;
    var Noticias;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            Noticias = (function () {
                function Noticias(_router, _contentService) {
                ...
                Noticias.prototype.gotoDetail = function (contenido) {
                    var link = ['NoticiaDetails', { id: contenido.id }];
